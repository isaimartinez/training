...
function loadBook(fileName, displayName){
    ...
    xhr.onreadystatechange = function () {
        if(xhr.readyState == 4 && xhr.status == 200){
            ...
            //Remove line breaks and carriage returns and replace...
...
function getDocStats(fileContent){
    ...
    ULTemplate(top5Words, document.getElementById("mostUsedWords"))
    ULTemplate(least5Words, document.getElementById("leastUsedWords"))
